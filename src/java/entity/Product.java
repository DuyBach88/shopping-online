...
public class Product {
    ...
    public Product(int product_id, int category_id, int discount, String product_name, String product_img, String product_desc, Double list_price, Date date_added, int quantity) {
        this.product_id = product_id;
    ...
    public Product(int product_id, int discount, String product_name, String product_img,
            String product_desc,
            Double list_price, Date date_added, int quantity, int category_id) {
        this.product_id = product_id;
        this.discount = discount;
        this.product_name = product_name;
        this.product_img = product_img;
    ...
    public Product(int product_id, int discount, String product_name,
            String product_img, String product_desc, Double list_price, 
            Date date_added, int quantity, int category_id, int brand_id) {
        this.product_id = product_id;
        this.discount = discount;
        this.product_name = product_name;
        this.product_img = product_img;
