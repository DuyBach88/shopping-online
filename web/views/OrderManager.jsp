...
<html lang="en">
    ...
    <body>
        ...
        <section>
        <div class="row h-100">
            <div class="col-md-2 h-100 left-nav-admin bg-black p-0">
                      ...
                      <ul>
                            ...
                            <li class="py-4 ps-3 mb-3">
                                <a href="ManageProduct" 
                                   class="fs-3 text-white d-flex align-items-center text-decoration-none">
            ...
            <div class="col-md-10 h-100">
                <h1 class="fw-bold my-4">Manage Order</h1>
                ...
                <div class="">
                    ...
                    <c:forEach items="${listOrder}" var="order">
                        ...
                        <div class="row fs-4 py-4 px-5 d-flex align-items-center justify-content-between">
                            ...
                            <div class="col text-danger fw-bold">${order.getStatus()}</div>
                            <div class="col">
                                <div class="d-flex align-items-center position-relative box-detail">
                                    <div class="">
                                        <span class="me-3">
                                            <a class="text-decoration-none text-info"
                                               href="orderManager?Service=detailOrder&OId=${order.getOrder_id()}">Detail</a>
                                        </span>
                                    </div>
                                    <div class="">
